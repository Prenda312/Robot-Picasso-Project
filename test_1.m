...
if (openPort(port_num))
    ...
    write2ByteTxRx(port_num, PROTOCOL_VERSION, 4, ADDR_AX_GOAL_POSITION, (180/pi)*(512/150)*6+512);
    ...
    while 1
        %     figure;
        %     strings={'PRESS ANY BUTTON TO CONTINUE';'(or input e to quit!)'};
        %     annotation('textbox',[0.35,0.5,0.3,0.15],'LineStyle','-','LineWidth',2,'String',strings);

        if input('Press any key to continue! (or input e to quit!)\n', 's') == ESC_CHARACTER
            figure;
            strings={'PRESS ANY BUTTON TO CONTINUE'};
            annotation('textbox',[0.35,0.5,0.3,0.1],'LineStyle','-','LineWidth',2,'String',strings);
            break;
        end
